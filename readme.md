...
[Add-DnsServerResourceRecordNS]: <#Add-DnsServerResourceRecordNS>
[Add-DnsServerResourceRecordSRV]: <#Add-DnsServerResourceRecordSRV>
[Add-DnsServerResourceRecordTxt]: <#Add-DnsServerResourceRecordTxt>
...
модуля DnsServer Windows Server 2012.
Синтаксис запроса:
	<https://pddimp.yandex.ru/nsapi/delete>_record.xml ?
...
модуля DnsServer Windows Server 2012.
Синтаксис запроса
	<https://pddimp.yandex.ru/nsapi/add>_a_record.xml ? token =<токен>
		& domain =<имя домена>
...
модуля DnsServer Windows Server 2012.
Синтаксис запроса:
	<https://pddimp.yandex.ru/nsapi/add>_aaaa_record.xml ? token =<токен>
		& domain =<имя домена>
		& [subdomain =<имя субдомена>]
		& [ttl =<время жизни записи>]
		& content =<содержимое записи>
...
Синтаксис запроса:
	<https://pddimp.yandex.ru/nsapi/add>_cname_record.xml ?
		token =<токен>
		& domain =<имя домена>
		& [subdomain =<имя субдомена>]
		& [ttl =<время жизни записи>]
...
Синтаксис запроса:
	<https://pddimp.yandex.ru/nsapi/add>_mx_record.xml ?
		token =<токен пользователя>
		 & domain =<имя домена>
		 & [subdomain =<имя субдомена>]
		 & [ttl =<время жизни записи>]
...
---------------------------------------
[Register-Admin]: <ITG.Yandex#Register-Admin>
[Remove-Admin]: <ITG.Yandex#Remove-Admin>
[Get-Admins]: <ITG.Yandex#Get-Admins>
[Invoke-API]: <ITG.Yandex#Invoke-API>
[Get-CachedToken]: <ITG.Yandex#Get-CachedToken>
[Register-Domain]: <ITG.Yandex#Register-Domain>
[Remove-Domain]: <ITG.Yandex#Remove-Domain>
[Remove-Logo]: <ITG.Yandex#Remove-Logo>
[Set-Logo]: <ITG.Yandex#Set-Logo>
[Get-Token]: <ITG.Yandex#Get-Token>
[ConvertFrom-Dictionary]: <ITG.Utils#ConvertFrom-Dictionary>
[ConvertTo-ObjectProperty]: <ITG.Utils#ConvertTo-ObjectProperty>
[Set-ObjectProperty]: <ITG.Utils#Set-ObjectProperty>
[Get-MIME]: <ITG.WinAPI.UrlMon#Get-MIME>
[Set-WindowForeground]: <ITG.WinAPI.User32#Set-WindowForeground>
[Set-WindowZOrder]: <ITG.WinAPI.User32#Set-WindowZOrder>
